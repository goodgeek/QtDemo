...
const QMetaObject JsonHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_JsonHandler.data,
      qt_meta_data_JsonHandler,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *JsonHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_JsonHandler.stringdata0))
        return static_cast<void*>(const_cast< JsonHandler*>(this));
