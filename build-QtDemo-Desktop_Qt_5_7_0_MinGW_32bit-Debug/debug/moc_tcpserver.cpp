...
QT_MOC_LITERAL(1, 10, 13), // "netMsgChanged"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 3) // "msg"

    },
    "TcpServer\0netMsgChanged\0\0msg"
};
...
void TcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->netMsgChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpServer::netMsgChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TcpServer::netMsgChanged(QString _t1)
{
