...
QT_MOC_LITERAL(1, 11, 14), // "xmlInfoChanged"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 4) // "info"

    },
    "XmlHandler\0xmlInfoChanged\0\0info"
};
...
void XmlHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        XmlHandler *_t = static_cast<XmlHandler *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->xmlInfoChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (XmlHandler::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&XmlHandler::xmlInfoChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject XmlHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_XmlHandler.data,
      qt_meta_data_XmlHandler,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void XmlHandler::xmlInfoChanged(QString _t1)
{
